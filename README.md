...
Índice con mis soluciones de Frontend Mentor. Cada tarjeta enlaza a su **código** y a la **demo**.
...
- Cada reto está en su propio repositorio individual (`frontendmentor-XX-nombre`).
- Cada repositorio tiene su propio **README**, **commits descriptivos** y **GitHub Pages** activado.
- Este repositorio sirve como **índice central** de mis prácticas y evolución con Frontend Mentor.
